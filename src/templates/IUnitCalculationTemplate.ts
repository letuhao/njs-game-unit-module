...
/**
 * Core unit calculation template interface - basic template operations
 */
export interface IUnitCalculationTemplateCore {
...
/**
 * Template metadata interface - metadata operations
 */
export interface IUnitCalculationTemplateMetadata {
...
/**
 * Template performance interface - performance operations
 */
export interface IUnitCalculationTemplatePerformance {
...
/**
 * Complete unit calculation template interface
 * Combines all template functionality
 */
export interface IUnitCalculationTemplate extends 
  IUnitCalculationTemplateCore,
  IUnitCalculationTemplateMetadata,
  IUnitCalculationTemplatePerformance {
}
