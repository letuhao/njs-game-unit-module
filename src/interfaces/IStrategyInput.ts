...
/**
 * Base strategy input interface - common properties
 */
...
/**
 * Size strategy input core interface - basic size properties
 */
export interface ISizeStrategyInputCore extends IBaseStrategyInput {
  /** Size value */
...
/**
 * Size strategy input advanced interface - advanced size properties
 */
export interface ISizeStrategyInputAdvanced {
...
/**
 * Position strategy input core interface - basic position properties
 */
export interface IPositionStrategyInputCore extends IBaseStrategyInput {
  /** Position value */
...
/**
 * Position strategy input advanced interface - advanced position properties
 */
export interface IPositionStrategyInputAdvanced {
...
/**
 * Scale strategy input core interface - basic scale properties
 */
export interface IScaleStrategyInputCore extends IBaseStrategyInput {
  /** Scale value */
...
/**
 * Scale strategy input advanced interface - advanced scale properties
 */
export interface IScaleStrategyInputAdvanced {
...
/**
 * Mixed strategy input core interface - basic mixed properties
 */
export interface IMixedStrategyInputCore extends IBaseStrategyInput {
  /** Size properties */
...
/**
 * Mixed strategy input advanced interface - advanced mixed properties
 */
export interface IMixedStrategyInputAdvanced {
  /** Mixed array */
  mixedArray?: Array<
