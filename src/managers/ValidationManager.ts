...
/**
 * Core validation manager interface - basic validation operations
 */
export interface IValidationManagerCore {
...
/**
 * Validation operations interface - validation operations
 */
export interface IValidationManagerOperations {
...
/**
 * Error management interface - error management operations
 */
export interface IValidationManagerErrors {
...
/**
 * Validator management interface - validator management operations
 */
export interface IValidationManagerValidators {
...
/**
 * Validation statistics interface - statistics operations
 */
export interface IValidationManagerStatistics {
...
/**
 * Complete validation manager interface
 * Combines all validation manager functionality
 */
export interface IValidationManager extends 
  IValidationManagerCore,
  IValidationManagerOperations,
  IValidationManagerErrors,
  IValidationManagerValidators,
  IValidationManagerStatistics {
}
